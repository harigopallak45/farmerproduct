		...
		<!-- Footer -->
			...
			<div class="footer-center">
				<div>
					...
					<p style="font-size:20px">T John College Of Institutions<span>Banglore</span></p>
				</div>
				<div>
					<i class="fa fa-phone"></i>
					<p style="font-size:20px">6364817511</p>
				</div>
				<div>
					<i class="fa fa-envelope"></i>
					<p style="font-size:20px"><a href="mailto:artistkattawce@gmail.com" style="color:white">harigopall45@gmail.com</a></p>
				</div>
			</div>
			...
			<div class="footer-right">
				<p class="footer-company-about" style="color:white">
					...
					Art Circle is a club established by the students of T John College Of Institutions<span>Banglore
to nurture the art various forms.
